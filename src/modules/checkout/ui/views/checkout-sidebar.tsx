    ...
    return (
        <div className="border rounded-md overflow-hidden bg-white flex flex-col">
            ...
            <div className="p-4 flex items-center justify-center">
                <Button variant={"elevated"} disabled={isPending} onClick={onCheckout} size={"lg"} className="text-base w-full text-white bg-primary hover:bg-pink-500 hover:text-primary">
                    Checkout
                </Button>
            </div>
            {isCanceled && (
